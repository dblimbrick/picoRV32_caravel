...
set_input_delay -max 2.0 -clock [get_clocks {clk}] [get_ports {mem_rdata[*]}]
set_input_delay -min 0.5 -clock [get_clocks {clk}] [get_ports {mem_rdata[*]}]

# Input delays - GPIO Interface
set_input_delay -max 2.0 -clock [get_clocks {clk}] [get_ports {io_in[*]}]
set_input_delay -min 0.5 -clock [get_clocks {clk}] [get_ports {io_in[*]}]
if { $::env(IO_SYNC) } {
	set in_ext_delay 4
...
set_output_delay -max 2.0 -clock [get_clocks {clk}] [get_ports {mem_en}]
set_output_delay -max 2.0 -clock [get_clocks {clk}] [get_ports {mem_we[*]}]
set_output_delay -max 2.0 -clock [get_clocks {clk}] [get_ports {mem_addr[*]}]
set_output_delay -max 2.0 -clock [get_clocks {clk}] [get_ports {mem_wdata[*]}]
set_output_delay -min 0.5 -clock [get_clocks {clk}] [get_ports {mem_en}]
set_output_delay -min 0.5 -clock [get_clocks {clk}] [get_ports {mem_we[*]}]
set_output_delay -min 0.5 -clock [get_clocks {clk}] [get_ports {mem_addr[*]}]
set_output_delay -min 0.5 -clock [get_clocks {clk}] [get_ports {mem_wdata[*]}]

# Output delays - GPIO Interface
set_output_delay -max 2.0 -clock [get_clocks {clk}] [get_ports {io_out[*]}]
set_output_delay -max 2.0 -clock [get_clocks {clk}] [get_ports {io_oeb[*]}]
set_output_delay -min 0.5 -clock [get_clocks {clk}] [get_ports {io_out[*]}]
set_output_delay -min 0.5 -clock [get_clocks {clk}] [get_ports {io_oeb[*]}]

# Output delays - Interrupts
set_output_delay -max 0.7  -clock [get_clocks {clk}] [get_ports {irq_out[*]}]
set_output_delay -min 0    -clock [get_clocks {clk}] [get_ports {irq_out[*]}]
if { $::env(IO_SYNC) } {
	set out_ext_delay 4
