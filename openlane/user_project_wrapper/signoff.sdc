...
# Date: 2023/06/20
# Modified for SIGNOFF: Final timing signoff constraints
...
#
# SIGNOFF Constraints:
# - Input/output delays: +0% (nominal)
# - Clock period: nominal (no reduction)
# - Derates: 2.5%
# - Clock uncertainties: 87.5 psec
...
# SIGNOFF: Set clock uncertainty to 87.5 psec (0.0875 ns)
set signoff_clock_uncertainty 0.0875
set_clock_uncertainty $signoff_clock_uncertainty [get_clocks {clk}]
puts "\[INFO\]: Setting clock uncertainity to: $signoff_clock_uncertainty (SIGNOFF: 87.5 psec)"
...
# SIGNOFF: Set derate to 2.5%
set signoff_timing_derate 0.025
set_timing_derate -early [expr {1-$signoff_timing_derate}]
set_timing_derate -late [expr {1+$signoff_timing_derate}]
puts "\[INFO\]: Setting timing derate to: [expr {$signoff_timing_derate * 100}] % (SIGNOFF: 2.5%)"
